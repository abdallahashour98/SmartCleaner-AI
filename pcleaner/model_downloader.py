...
try:
    from transformers.utils.constants import HF_HUB_CACHE as TRANSFORMERS_CACHE
except ImportError:
    try:
        from transformers.file_utils import default_cache_path as TRANSFORMERS_CACHE
