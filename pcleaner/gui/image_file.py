...
class ImageFile:
    ...
    canceled: bool = False  # Whether the image cleaning was canceled by the user during review.
...
class MergedImageFile:
    ...
    def __init__(
        ...
        self.canceled = all(image.canceled for image in image_files)
        ...
        merge_files = [
            ie.ExportTarget(image.path, image.export_path, image.uuid, [], image.canceled)
